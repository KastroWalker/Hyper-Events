...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../lib/css/style_cadastro_eveto.css">
...
<body>
    ...
    <main>
        <section id="Cadastrar_Evento">
            ...
            <form method="POST" action="../../../Control/Evento_Control.php?acao=cadastrar" id="form_cadastro" onsubmit="return valida_cadastro();">
    ...
    <script src="../../../lib/js/valida_cadastro_evento.js"></script>
    <?php
