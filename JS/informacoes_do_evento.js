...
//[ "1", "Introdução a python", "Minicurso", "30", "20", "Como programar com python", "2019-12-27", "Laboratorio 01", "08:00:00", "Emilly Horta" ]
        console.log(data);
        document.getElementById("titulo_atividade").innerHTML = data[1];
        document.getElementById("tipo_atividade").innerHTML = data[2];
        document.getElementById("vagas_atividade").innerHTML = data[3];
        document.getElementById("valor_atividade").innerHTML = data[4];
        document.getElementById("desc_atividade").innerHTML = data[5];
        document.getElementById("data_atividade").innerHTML = data[6];
        document.getElementById("local_atividade").innerHTML = data[7];
