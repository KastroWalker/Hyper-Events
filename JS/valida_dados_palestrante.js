function valida_dados_palestrante(){
	/* 
	...
	*/
	...
	function valida_nome(){
         ...
         */
         var nome = document.forms['form_cadastro_palestrante'].campo_nome.value;
         var nome = nome.replace( /\s/g, '' );
         var name_class = document.forms['form_cadastro_palestrante'].campo_nome.className;
         if (/[^a-zA-Z]/.test(nome)) {
            var new_name_class = name_class + ' is-invalid';
            document.forms['form_cadastro_palestrante'].campo_nome.className = new_name_class;
            form_cadastro.campo_nome.focus();
            return false;
        } else {
            document.forms['form_cadastro_palestrante'].campo_nome.className = name_class;
        }
     ...
     function valida_sexo(){
         ...
         */
         var sexo = document.forms["form_cadastro_palestrante"].campo_sexo.selectedIndex;
         var name_class = document.forms['form_cadastro_palestrante'].campo_sexo.className;
         if (sexo == 0) {
         	var new_name_class = name_class + ' is-invalid';
         	document.forms['form_cadastro_palestrante'].campo_sexo.className = new_name_class;
         	return false;
         } else {
         	document.forms['form_cadastro_palestrante'].campo_sexo.className = name_class;
         }
         return true;
     }
     ...
     function valida_cpf() {
     	var Soma;
     	var Resto;
     	var cpf = document.forms['form_cadastro_palestrante'].campo_cpf.value;
     	var cpf = cpf.replace('.', '');
     	var cpf = cpf.replace('.', '');
     	var cpf = cpf.replace('-', '');
     	var name_class = document.forms['form_cadastro_palestrante'].campo_cpf.className;
     	Soma = 0;
     	...
     	if (Resto != parseInt(cpf.substring(9, 10)) ){
     		var new_name_class = name_class + ' is-invalid';
     		document.forms['form_cadastro_palestrante'].campo_cpf.className = new_name_class;
     		return false;      
     	} 
     ...
     function valida_data_nasc(){
        /**
          ...
          */
          ...
          var name_class = document.forms['form_cadastro_palestrante'].campo_data_nasc.className;
          var new_name_class = name_class + ' is-invalid';

        // Pegando a data de nascimento do usuario
        var data_passada = document.forms['form_cadastro_palestrante'].campo_data_nasc.value;
        ...
        if(data_passada.length > 10 || data_passada.length < 10){
        	document.forms['form_cadastro_palestrante'].campo_data_nasc.className = new_name_class;
        	return false;
        }
